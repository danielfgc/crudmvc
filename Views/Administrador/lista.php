    ...
    <main class="container">
      ...
      <section class="container m-5 bg-white">          
        <table class="table table-striped ">
          ...
          <tbody>
            <tr>
              <td><img src="https://t2.uc.ltmcdn.com/images/0/3/2/img_como_alejarse_de_una_persona_toxica_45230_600.jpg" alt="..." class="img-fluid rounded-pill" width="70px"> </td>
              <td>Doe</td>
              <td>john@example.com</td>
              <td>Admin</td>
              <td><a href="#" class="editar">Editar Perfil</a></td>
              <td>
            ...
            <tr>
              ...
              <td>Admin</td>
              <td><a href="#" class="editar">Editar Perfil</a></td>
              <td> <a href="#"><i class="fas fa-trash-alt" id="eliminar" data-bs-toggle="modal" data-bs-target="#staticBackdrop"></i></a>
