...
public function getemail(){
	...
	public static function all(){
		...
		$select=$db->query('call fichaUser()');
 
		foreach($select->fetchAll() as $Usuario){
			$Usuario=new Usuario($Usuario['id'],$Usuario['username'],$Usuario['email'],$Usuario['contraseña'],$Usuario['urlfoto'],$Usuario['pregunta'],$Usuario['respuesta'],$Usuario['idrol'],$Usuario['binfoto']);
		}
		return $Usuario;
	}
